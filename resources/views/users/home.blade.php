    ...
    <div class="col-8">
        ...
        @empty
            ...
            <div class="text-center">
                <h2>Share Photos</h2>
                <p class="text-muted">When you share photos, they'll appeare on your profile.</p>
        ...
        @if ($suggested_users)
            <div class="row">
                ...
                <div class="col text-end">
                    <a href="{{ route('getAllSuggestedUsers') }}" class="fw-bold text-dark text-decoration-none">See All</a>
                </div>
            </div>

        ...
        <div class="modal-content border-primary">
            ...
            <div class="modal-footer border-0">
                <form action="{{ route('admin.posts.unhide', $post->id) }}" method="post">
                    ...
                    <button type="button" class="btn btn-outline-primary btn-sm" dat-bs-dismiss="modal">Cancel</button>
        ...
        <div class="modal-content border-danger">
            ...
            <div class="modal-footer border-0">
                <form action="{{ route('admin.posts.hide', $post->id) }}" method="post">
                    ...
                    <button type="button" class="btn btn-outline-danger btn-sm" dat-bs-dismiss="modal">Cancel</button>
